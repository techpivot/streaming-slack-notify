...
export const DYNAMODB_SLACK_TABLE_NAME = 'techpivot-streaming-slack-notify-slack-auths';

export const DYNAMODB_GITHUB_TABLE_NAME = 'techpivot-streaming-slack-notify-github-auths';
