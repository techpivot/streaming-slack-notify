...
resource "aws_ssm_parameter" "slack_client_id" {
  name        = "/${var.namespace}/${var.name}/prod/slack/client_id"
...
resource "aws_ssm_parameter" "slack_client_secret" {
  name        = "/${var.namespace}/${var.name}/prod/slack/client_secret"
...
resource "aws_ssm_parameter" "slack_signing_secret" {
  name        = "/${var.namespace}/${var.name}/prod/slack/signing_secret"
